...
if __name__ == "__main__":
    ...
    arg_parser.add_argument("-p", "--path", help="subtitle file path", required=False)
    arg_parser.add_argument("-r", "--rate", help="speech rate(words per minute)", type=int, default=120)
    arg_parser.add_argument("-v", "--voice-idx", help="voice selection", type=int, default=0, choices=[0, 1])

    args = arg_parser.parse_args()

    generate_audio(path='Youtube/50 худших дней [zP1Y69vQrOk][EN].srt', rate=args.rate, voice_idx=0)
